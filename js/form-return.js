...
function Validation(theNewContact){
	 ...
	 var contenidos='?order='+theNewContact.order.value+'&email='+theNewContact.email.value+'&comments='+theNewContact.comments.value+'&fname='+theNewContact.fname.value+'&lname='+theNewContact.lname.value+'&refund='+theNewContact.refund.value;
	 makeRequest('sendreturn.php', contenidos, 'contactform');
	 return (false);
	}
