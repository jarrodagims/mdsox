            ...
            <div class="column column1 ">
                ...
                <div class="social m-t-20">
                    <a class="button-style4 type2 color1">
                        <img class="icon svg" src="<?=get_stylesheet_directory_uri(); ?>/media/images/icon-facebook.svg"
                            alt="" />
                    </a>
                    <a class="button-style4 type2 color1">
                        <img class="icon svg" src="<?=get_stylesheet_directory_uri(); ?>/media/images/icon-twitter.svg"
                            alt="" />
                    </a>
                </div>
            </div>
